          ...
          <View className="gap-8 pt-[8vh]">
            ...
            <View className="gap-10">
              ...
              <View className="gap-4 mx-4">
                ...
                {/* Forgot Password */}
                <TouchableOpacity style={{ alignSelf: "flex-end" }} onPress={()=>router.push("/forgetpassword")} >
                  <Text
                    style={{ fontSize: hp(2.2), marginVertical: hp(-0.5) }}
                    className="font-semibold px-4 text-indigo-500">
                    Forgot Password?{" "}
                  </Text>
                </TouchableOpacity>
